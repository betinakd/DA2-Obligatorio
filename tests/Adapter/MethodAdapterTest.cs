...
public class MethodAdapterTest
{
    ...
    public void CreateVariable_ShouldThrowInvalidAttribute_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockSimClassService!
            ...
            .Throws(new SimClassInvalidAttribute("SimClass error"));
    ...
    public void GetParameter_ShouldThrowInvalidOperationException_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockMethodService.Setup(s => s.GetParameterById(parameterId)).Throws(new SimClassInvalidAttribute("error"));
    ...
    public void GetVariable_ShouldThrowInvalidOperationException_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockMethodService.Setup(s => s.GetVariableById(variableId)).Throws(new SimClassInvalidAttribute("error"));
    ...
    public void GetMethod_ShouldThrowInvalidOperationException_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockMethodService.Setup(s => s.GetMethodById(methodId)).Throws(new SimClassInvalidAttribute("error"));
    ...
    public void CreateMethod_ShouldThrowInvalidAttribute_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockSimClassService.Setup(s => s.GetSimClassById(idClass)).Throws(new SimClassInvalidAttribute("SimClass error"));
    ...
    public void DeleteMethod_ShouldThrowInvalidOperationException_WhenSimClassInvalidAttributeIsThrown()
    {
        ...
        _mockMethodService.Setup(s => s.DeleteMethod(methodId)).Throws(new SimClassInvalidAttribute("error"));
    ...
    public void CreateInvocation_WithBaseReference_ShouldReturnCreatedInvocationResponse()
    {
        ...
        // Asignar la clase base correctamente
        simClass.BaseClassId = referenceId;
        typeof(SimClass)
            .GetField("_baseClassField", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            ?.SetValue(simClass, baseClass);

        // Asegurarse de que cualquier instancia de simClass que devuelva el mock tenga la base seteada
        _mockSimClassService!.Setup(s => s.GetSimClassById(classTypeId)).Returns(() =>
        {
            // Siempre devolver la misma instancia con la base seteada
            typeof(SimClass)
                .GetField("_baseClassField", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
                ?.SetValue(simClass, baseClass);
            return simClass;
        ...
        _mockMethodService.Setup(s => s.AddInvocation(methodId, It.IsAny<Invocation>()))
            .Returns((Guid id, Invocation inv) => inv);
        _mockExecutionService.Setup(s => s.ValidateMethodExistsInClass(baseClass, signature));
